...
/**
*  ViewController to configure the information sent for the accelerometer
*/
class ACDetailViewController: UIViewController {
    ...
    let maxValueData : [Double] = [ 1, 2, 3, 4 ]
    
    /// The object that stores the accelerometer information
